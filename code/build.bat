...
cl %COMMON_COMPILER_FLAGS% /MDd /Fe"game_loader.exe" ../code/game_loader_windows.cpp /link /SUBSYSTEM:WINDOWS glfw/glfw3dll.lib user32.lib gdi32.lib shell32.lib
