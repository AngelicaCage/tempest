...
cl %COMMON_COMPILER_FLAGS% /MD /Fe"game_loader.exe" ../code/game_loader_windows.cpp /link /SUBSYSTEM:WINDOWS glfw-lib-static-ucrt/glfw3dll.lib user32.lib gdi32.lib shell32.lib winmm.lib ole32.lib
